        ...
        <div className="px-4 w-[50vw]">
          ...
          <div className="flex justify-center space-x-6 mb-6">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-300 hover:text-gray-500 transition text-2xl"
            >
              <FaGithub />
            </a>
            <a
              href="mailto:ayushkhobragade17@gmail.com"
              className="text-gray-300 hover:text-red-500 transition text-2xl"
            >
              <FaEnvelope />
            </a>
                {/* <a
